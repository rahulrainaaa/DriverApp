...
/**
 * Map navigate from current point to Customer.
 */
public class Current2CustMapActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerClickListener, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Current2CustMapActivity.this.getRoutingPath();
                fab.setClickable(false);
    ...
    protected void onResume() {
        ...
        if (!PermissionCheck.getInstance().checkGPSPermission(this, locationManager)) {
            ...
            Toast.makeText(Current2CustMapActivity.this, getResources().getString(R.string.fetching_location), Toast.LENGTH_SHORT).show();
            try {
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);
                locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 5000, 0, this);
            } catch (Exception e) {
                Toast.makeText(Current2CustMapActivity.this, "ERROR: Cannot start location listener", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        destMarker = mMap.addMarker(new MarkerOptions().position(Constants.POINT_DEST).title("Customer").icon(BitmapDescriptorFactory.fromResource(R.drawable.pinc)));
    ...
    public void onLocationChanged(Location location) {
        ...
        if (firstRefresh) {
            //Add Start Marker.
            currentMarker = mMap.addMarker(new MarkerOptions().position(currentLatLng).title("Current"));
            firstRefresh = false;
            getRoutingPath();
        } else {
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        } else if (marker.getTitle().contains("Origin")) {
    ...
    public void onRoutingFailure(RouteException e) {
        Toast.makeText(Current2CustMapActivity.this, getResources().getString(R.string.routing_failed), Toast.LENGTH_SHORT).show();
    ...
    public void onRoutingSuccess(ArrayList<Route> list, int i) {
        try {
            ...
            Toast.makeText(Current2CustMapActivity.this, "EXCEPTION: Cannot parse routing response", Toast.LENGTH_SHORT).show();
        }
        fab.setClickable(true);
    }
    ...
    public void onRoutingCancelled() {
        Toast.makeText(Current2CustMapActivity.this, getResources().getString(R.string.routing_cancelled), Toast.LENGTH_SHORT).show();
        fab.setClickable(true);
    }
    ...
    private void getRoutingPath() {
        try {
            ...
            Toast.makeText(Current2CustMapActivity.this, getResources().getString(R.string.unable_to_find_route), Toast.LENGTH_SHORT).show();
        }
    }
}
