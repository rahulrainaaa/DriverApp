...
/**
 * Map navigate from current point to Restaurant and then to Customer.
 */
public class Current2Rest2CustMapActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleMap.OnMarkerClickListener, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Constants.POINT_DEST = GeoUtils.parseLatLng(Constants.order.google.trim());// new LatLng(18.758663, 73.382025);        //Lonavala destination.
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Current2Rest2CustMapActivity.this.getRoutingPath();
                fab.setClickable(false);
    ...
    protected void onResume() {
        ...
        if (!PermissionCheck.getInstance().checkGPSPermission(this, locationManager)) {
            ...
            Toast.makeText(Current2Rest2CustMapActivity.this, getResources().getString(R.string.fetching_location), Toast.LENGTH_SHORT).show();
            try {
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);
                locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 5000, 0, this);
            } catch (Exception e) {
                Toast.makeText(Current2Rest2CustMapActivity.this, "ERROR: Cannot start location listener", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        destMarker = mMap.addMarker(new MarkerOptions().position(Constants.POINT_START).title(getResources().getString(R.string.restaurant)).icon(BitmapDescriptorFactory.fromResource(R.drawable.pinr)));
    ...
    public void onRoutingFailure(RouteException e) {
        Toast.makeText(Current2Rest2CustMapActivity.this, getResources().getString(R.string.routing_failed), Toast.LENGTH_SHORT).show();
    ...
    public void onRoutingSuccess(ArrayList<Route> list, int i) {
        try {
            ...
            builder.include(Constants.POINT_START);
            LatLngBounds bounds = builder.build();
            mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(bounds, 50));
        } catch (Exception e) {
            Toast.makeText(Current2Rest2CustMapActivity.this, "EXCEPTION: Cannot parse routing response", Toast.LENGTH_SHORT).show();
        }
        fab.setClickable(true);
    }
    ...
    public void onRoutingCancelled() {
        Toast.makeText(Current2Rest2CustMapActivity.this, getResources().getString(R.string.routing_cancelled), Toast.LENGTH_SHORT).show();
        fab.setClickable(true);
    }
    ...
    private void getRoutingPath() {
        try {
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .withListener(this)
                    .waypoints(currentLatLng, Constants.POINT_START, Constants.POINT_DEST)
                    .build();
            routing.execute();
        } catch (Exception e) {
            Toast.makeText(Current2Rest2CustMapActivity.this, getResources().getString(R.string.unable_to_find_route), Toast.LENGTH_SHORT).show();
        }
    }
}
