...
/**
 * Freelance Driver: Navigate to Customer - Map Activity.
 */
public class FreelanceNav2Customer extends FragmentActivity implements OnMapReadyCallback, LocationListener, RoutingListener {
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, FreelanceDeliverActivity.class));
        super.onBackPressed();
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(GeoUtils.parseLatLng(order.google.trim())).title(getResources().getString(R.string.customer)).icon(BitmapDescriptorFactory.fromResource(R.drawable.pinc)));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(GeoUtils.parseLatLng(order.google.trim())));
        ...
        if (currentMarker == null) {
            ...
            try {
                ...
                Routing routing = new Routing.Builder()
                        ...
                        .withListener(this)
                        .waypoints(currentLatLng, GeoUtils.parseLatLng(order.google.trim()))
                        .build();
                routing.execute();
            } catch (Exception e) {
    ...
    public void onRoutingSuccess(ArrayList<Route> list, int i) {
        ...
        try {
            ...
            builder.include(GeoUtils.parseLatLng(order.google.trim()));
