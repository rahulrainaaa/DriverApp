...
/**
 * Sponsored Driver: Show all reverse orders from offline SQLite DB - Show List Activity.
 */
public class SponsoredReverseListActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    private void doRefreshList() {
        Cursor cursor = SQLiteHandler.getInstance().query(Constants.SQL_QUERY + " where status = 'reverse';");
        list.clear();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Snackbar.make(view, getResources().getString(R.string.this_order_is_reveresed), Snackbar.LENGTH_LONG).show();
    }
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Snackbar.make(view, getResources().getString(R.string.see_on_map_q), Snackbar.LENGTH_LONG).setAction(getResources().getString(R.string.show), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SponsoredReverseListActivity.this, ShowCoordinateMapActivity.class));
            }
        }).show();
        return true;
    }
